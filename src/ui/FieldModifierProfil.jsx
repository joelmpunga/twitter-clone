...
export default function FieldModifierProfil({ isTextArea = false,labelText,name,valeur,bordercol="border-gray-500"}) {
    ...
    return (
        <div className={'border rounded-lg px-2 m-5 '+bordercol}>
