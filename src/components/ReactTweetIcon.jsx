...
export default function ReactTweetIcon({ tweet }) {
  return (
    <div className='flex gap-10 space-x-6 m-2'>
      ...
      <IconReactTweet icone="src/assets/Retweet1.svg" svg="src/assets/Retweet.svg" iconeOver="src/assets/Retweet1.svg" countNumber={tweet.retweets} textColor="text-blue-500" />
      ...
      <IconReactTweet icone="src/assets/Share.svg" svg="src/assets/Share.svg" iconeOver="src/assets/Share.svg" />
    </div>
  )
}
