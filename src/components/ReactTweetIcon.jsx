...
export default function ReactTweetIcon({ posts, users, comments }) {
  ...
  return (
    <div className='flex gap-10 space-x-6 m-2'>
      ...
      <IconReactTweet iconeClick="src/assets/React1.svg" svgDefault="src/assets/React.svg" iconeOver="src/assets/React2.svg" countNumber={posts.like?posts.like:0} textColor="text-red-500" />
